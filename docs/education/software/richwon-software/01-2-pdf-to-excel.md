...
PDF는 스캔본 PDF와 컴퓨터로 작성한 문서 PDF가 있습니다.  드래그 여부로 PDF 종류를 간단히 체크할 수 있습니다.
* [스캔본 PDF 일 경우:](#스캔본-pdf-일-경우) 스캔본은 단순한 이미지이기 때문에 PDF 문서 안에 글자 정보가 없습니다. 
* [글자 드래그 되는 PDF 일 경우:](#글자-드래그-되는-pdf-일-경우) 컴퓨터로 작성한 PDF 문서는 실제로 PDF 안에 글자 정보가 있기 때문에 글자에 드래그가 됩니다.
